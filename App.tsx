      ...
      {currentView === 'HOME' && (
        <>
          ...
          <section className="w-full py-8 md:py-12">
             <RevealOnScroll>
                 <div className="relative h-[350px] md:h-[450px] w-full bg-gray-900 flex items-center justify-end overflow-hidden" onClick={() => handleNavigate('PERFUMES')}>
             ...
             <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                   {[
                     ...
                     <div key={idx} className="relative aspect-square group overflow-hidden shadow-lg cursor-pointer" onClick={() => handleNavigate('ABOUT US')}>
          ...
          <section className="py-12 md:py-20 bg-[#F4F4F4]">
             <div className="container mx-auto px-4">
                ...
                <div className="flex overflow-x-auto gap-4 md:gap-6 pb-8 scrollbar-hide snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0">
                   {STORES.map(store => (
                      <div key={store.id} className="min-w-[280px] md:min-w-[350px] bg-white shadow-lg snap-center group cursor-pointer first:ml-4 last:mr-4 md:first:ml-0 md:last:mr-0" onClick={() => handleNavigate('STORES')}>
